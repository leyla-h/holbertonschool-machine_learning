...
def P_init(X, perplexity):
    ...
    Returns: (D, P, betas, H)
        ...
        betas: a numpy.ndarray of shape (n, 1) initialized to all
            1's that will contain all of the beta values
        H is the Shannon entropy for perplexity perplexity with
            a base of 2
    """
    n, d = X.shape
