...
class Decision_Tree:
    ...
    # Required helper methods (implement these based on class structure)
    def depth(self): return 0 # Implement recursive depth calculation
    def count_nodes(self, only_leaves=False): return 0 # Implement recursive count
